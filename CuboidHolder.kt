...
////    }
////
////    fun lengthSq(coord: Coordinate): Float {
...
////    }
////
////    fun normalize(coord: Coordinate): Coordinate {
...
////    }
////
////    fun multiply(scaleFactor: Float, coord: Coordinate): Coordinate {
////        coord.x *= scaleFactor
////        coord.y *= scaleFactor
////        return coord
////    }
...
////                if (i == j)
////                    continue
////                var coord: Coordinate = Coordinate(finalCircles[j].mCenterX - finalCircles[i].mCenterX, finalCircles[j].mCenterY - finalCircles[i].mCenterX)
...
////            if (finalCircles[i] != draggingCircle) {
////                var coord: Coordinate = Coordinate(finalCircles[i].mCenterX - centerXLayout, finalCircles[i].mCenterY - centerYLayout)
